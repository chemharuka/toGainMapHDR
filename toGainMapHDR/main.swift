...
var tonemappingratio: Float? = 2.0
...
func bicubicResizeImage(originalImage: CIImage, ratio: Float) -> CIImage {
    let bicubicScaleFilter = CIFilter.bicubicScaleTransform()
    bicubicScaleFilter.inputImage = originalImage
    bicubicScaleFilter.aspectRatio = 1
    bicubicScaleFilter.parameterB = 1.0/ratio
    bicubicScaleFilter.parameterC = 1.0/ratio
...
hdr_image = hdr_image.applyingFilter("CIToneMapHeadroom", parameters: ["inputSourceHeadroom":8.0,"inputTargetHeadroom":8.0])
pic_headroom = maxLuminance(from: hdr_image)!
pic_headroom2 = maxLuminance(from: lanczosResizeImage(originalImage: hdr_image, ratio:tonemappingratio!))!
